...
CALIBRATION_VALUES_SECTION_SIZE ?= 0x1000
...
export LDS_SECTION_FLAGS := \
	-DCALIBRATION_VALUES_SECTION_SIZE=$(CALIBRATION_VALUES_SECTION_SIZE) \
...
ifeq ($(BLE),1)
KBUILD_CPPFLAGS += -DBESBT_STACK_SIZE=1024*10+512
else
...
export NV_RESET_IBRT_ROLE ?= 0
ifeq ($(NV_RESET_IBRT_ROLE),1)
KBUILD_CPPFLAGS += -DNV_RESET_IBRT_ROLE
endif
